...
\iftoggle{onepage}{\newcommand{\sectionskip}{-3mm}}{\newcommand{\sectionskip}{-2mm}}
\titleformat{\section}{\Large\scshape\color{headings}}{\thesection}{2mm}{\vspace{\sectionskip}}[\vspace{-4mm}\hrulefill\vspace{-2mm}]
...
\newenvironment{project}[4][]  % optional link is by default empty
{
    ...
    {
        \href{#1}{\heading{#2}}\\
        \textcolor{misc}{\textit{\small #4} \hfill{\small #3}}\\[-6mm]
        \begin{itemize}[itemsep=0mm]
    }
    {
        \heading{#2} \hfill{\small #3}\\
        \textcolor{misc}{\textit{\small #4} \hfill\href{#1}{\small #1}}\par
        \begin{itemize}
    }
}
{
...
{%
    ...
    {
        \href{#1}{\heading{#2}}\\
        \textcolor{misc}{\textit{\small #4} \hfill{\small #3}}\par
    }
    {
        \heading{#2} \hfill{\small #3}\\
        \textcolor{misc}{\textit{\small #4} \hfill\href{#1}{\small #1}}\par
