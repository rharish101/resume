...
\titleformat{\section}{\Large\scshape}{\thesection}{2mm}{\vspace{\sectionskip}}[\vspace{-4mm}\hrulefill\vspace{-2mm}]
...
\newenvironment{project}[4][]  % optional link is by default empty
{
    ...
    }
    {
        ...
        \textit{\small #4} \hfill\href{#1}{\small #1}\par
        \begin{itemize}
    }
}
{
...
{%
    ...
    {
        \href{#1}{\color{black}{\textbf{#2}}}\\
        \textit{\small #4} \hfill{\small #3}\par
    }
    {
        \textbf{#2} \hfill{\small #3}\\
        \textit{\small #4} \hfill\href{#1}{\small #1}\par
