...
\item \begin{project}{Deblurring by Synthesizing Blur}{Feb '21 -- Present}{Prof.\ Dr.\ Marc Pollefeys}%chktex 8
    \item Ongoing semester project to remove motion blur using a neural network to de-blur individual frames as well as generate `sub-frames', as if captured by a high-speed camera.
    \item Builds upon \href{https://arxiv.org/abs/2012.00595}{DeFMO}, a generative model that re-constructs sharp contours and time-varying complex appearance of fast moving objects that move over 3D trajectories with 3D rotation.
\end{project}
...
\item \emptyproject[https://github.com/rharish101/CS771-Project]{Higher-Order Optimisation in Deep Learning}{Sept '18 -- Nov '18}{Prof.\ Piyush Rai, CS771A Course Project}%chktex 8
