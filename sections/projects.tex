...
\item \begin{project}{Learning Rate Schedulers and Generalization}{Sep '21 -- present}{Prof.\ Thomas Hofmann}%chktex 8
    \item Ongoing semester project to investigate the effects of various learning rate schedules for deep learning optimizers towards generalization.
\end{project}
