...
\item \begin{project}{Step-Size Scheduling for Minimax Problems}{Mar '22 -- present}{Prof.\ Niao He}%chktex 8
    \item Ongoing master thesis to investigate the ``constant and cut'' step-size scheduling used in conjunction with algorithms for solving minimax problems.
\end{project}
