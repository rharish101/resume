...
\item \begin{project}[https://github.com/rharish101/multistage-step-size-scheduling-minimax]{Multistage Step Size Scheduling for Minimax Problems}{Mar '22 -- Sep '22}{\iffull{Prof.\ Dr.\ Niao He, }ETH Zürich}%chktex 8
    \item \textbf{Master's thesis} on analysing and experimenting with multistage schedulers for the learning rate on minimax problems in machine learning and deep learning.
    \iffull{
...
\item \slimproject[https://arxiv.org/abs/2004.09803]{CovidAID:\ COVID-19 Detection Using Chest X-Rays}{Apr '20 -- Aug '20}{\iftoggle{onepage}{IIT Kanpur \& IIT Delhi \& AIIMS}{Prof.\ Vinay Namboodiri, Prof.\ Chetan Arora, Prof.\ Krithika Rangarajan}}{%chktex 8
...
\item \slimproject{Interactive Training of GANs}{Jan '19 -- \iffull{Apr '19, Aug '19 -- }Dec '19}{\iffull{Prof.\ Vinay Namboodiri, Prof.\ Chetan Arora, }IIT Kanpur}{%chktex 8
...
\item \slimproject[https://github.com/rharish101/UGP1/]{Multi-Agent GANs for Image Super-Resolution}{Aug '18 -- Dec '18}{\iffull{Prof.\ Vinay Namboodiri, }IIT Kanpur}{%chktex 8
